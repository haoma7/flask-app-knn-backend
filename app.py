...
def predict():
    ...
    if output>str(0.5):
        return render_template('result.html',pred=f'You have a high chance of diabetes.')
    else:
        return render_template('result.html',pred=f'You have a low chance of diabetes.')
